...
const editProduct = async (req, res) => {
  const id = req.params.id;
        ...
        prod.findByIdAndUpdate( ireq.session.user._id, { name:req.body.ProductName,quantity: req.body.quantity, price: req.body.price,description: req.body.description  })
        .then(result => {
